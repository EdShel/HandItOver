...
namespace HandItOver.BackEnd.DAL.Migrations
{
    ...
    [Migration("20210318175949_FirebaseTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HandItOver.BackEnd.DAL.Entities.Auth.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "0ea8df9a-405b-4778-b2c6-35953bb2348d",
                            Name = "user",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "69e01990-fa37-4b0e-9d46-f5534a748e20",
                            Name = "admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "08b2fb75-d541-4cd9-b3d2-3c3cd44b4795",
                            Name = "mailbox",
            ...
            modelBuilder.Entity("HandItOver.BackEnd.DAL.Entities.FirebaseToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HandItOver.BackEnd.DAL.Entities.WhitelistJoinToken", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HandItOver.BackEnd.DAL.Entities.FirebaseToken", b =>
                {
                    b.HasOne("HandItOver.BackEnd.DAL.Entities.Auth.AppUser", "User")
                        ...
                        .HasForeignKey("HandItOver.BackEnd.DAL.Entities.FirebaseToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HandItOver.BackEnd.DAL.Entities.WhitelistJoinToken", b =>
                {
                    b.HasOne("HandItOver.BackEnd.DAL.Entities.MailboxGroup", "Group")
                        .WithMany("WhitelistJoinTokens")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HandItOver.BackEnd.DAL.Entities.MailboxGroup", b =>
                {
                    ...
                    b.Navigation("WhitelistJoinTokens");
                });
